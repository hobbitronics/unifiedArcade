...
<main>
  <Card padded>
    ...
    <p>
      This is a game where you must follow the instructions to become familiar
      with using the terminal. This isn't a real terminal so no using "*". If
      you succesfully complete a challenge you get a point. If you make a
      mistake you lose a point.
    </p>

    <h3>Here are some common commands to help you out.</h3>
    <div>
      <p>1. cat filename - Displays a filename</p>
      <p>2. cd dirname - Moves you to the identified directory</p>
      <p>
        3. cp file1 file2 - Copies one file/directory to the specified location
      </p>
      <p>4. file filename - Identifies the file type (binary, text, etc)</p>
      <p>5. find filename dir - Finds a file/directory</p>
      <p>6. head filename - Shows the beginning of a file</p>
      <p>
        7. less filename - Browses through a file from the end or the beginning
      </p>
      <p>8. ls dirname - Shows the contents of the directory specified</p>
      <p>9. mkdir dirname - Creates the specified directory</p>
      <p>
      ...
      <p>12. pwd - Shows the current directory the user is in</p>
      <p>13. rm filename - Removes a file</p>
      <p>14. rmdir dirname - Removes a directory -</p>
      <p>15. tail filename - Shows the end of a file</p>
      <p>
        16. touch filename - Creates a blank file or modifies an existing file
        or its attributes
      </p>
      <p>17. whereis filename - Shows the location of a file</p>
      <p>
    ...
    <h4>
      Type in the requested command and hit enter or click the button to play.
    </h4>
  </Card>
  <br />
  <Paper elevation={4}>
    <div class="terminal grn-border">
      ...
      <form on:submit|preventDefault={() => play(input.toLowerCase(), counter)}>
        {$currPlayer.name}{prompt[counter]}<input
          class="grn-border"
          type="text"
